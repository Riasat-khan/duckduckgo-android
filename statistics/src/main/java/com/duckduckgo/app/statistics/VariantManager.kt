...
interface VariantManager {
    ...
    companion object {
        ...
        val ACTIVE_VARIANTS = listOf(
            ...
            // Returning users
            Variant(key = "zc", weight = 1.0, features = emptyList(), filterBy = { isEnglishLocale() }),
            Variant(key = "za", weight = 1.0, features = listOf(VariantFeature.ReturningUsersNoOnboarding), filterBy = { isEnglishLocale() }),
            Variant(key = "zw", weight = 1.0, features = listOf(VariantFeature.ReturningUsersWidgetPromotion), filterBy = { isEnglishLocale() }),
        )
